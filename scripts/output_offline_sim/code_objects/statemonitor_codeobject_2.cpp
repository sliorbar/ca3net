...
void _run_statemonitor_codeobject_2()
{
...
const size_t _numt = _dynamic_array_statemonitor_t.size();
    ...
    _dynamic_array_statemonitor_w_exc.resize(_new_size, _num_indices);
    ...
    for (int _i = 0; _i < (int)_num_indices; _i++)
    {
        ...
        const double _source_w_exc = _ptr_array_synapses_1_w_exc[_idx];
        const double _to_record_w_exc = _source_w_exc;


        _dynamic_array_statemonitor_w_exc(_new_size-1, _i) = _to_record_w_exc;
    }
