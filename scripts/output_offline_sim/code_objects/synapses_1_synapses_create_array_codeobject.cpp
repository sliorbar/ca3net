...
const size_t _numsources = 6393354;
const size_t _numtargets = 6393354;
...
_dynamic_array_synapses_1_Apostsyn.resize(newsize);
_dynamic_array_synapses_1_Apresyn.resize(newsize);
_dynamic_array_synapses_1_delay_1.resize(newsize);
_dynamic_array_synapses_1_lastupdate.resize(newsize);
_dynamic_array_synapses_1_w_exc.resize(newsize);
