...
const int64_t N_post = 8000;
const int64_t N_pre = 300;
...
const size_t _numsources = 239691;
const size_t _numtargets = 239691;
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_3__synaptic_post.size();
const size_t _num_presynaptic_idx = _dynamic_array_synapses_3__synaptic_pre.size();
    ///// POINTERS ////////////
...
const size_t _old_num_synapses = _ptr_array_synapses_3_N[0];
...
const size_t newsize = _dynamic_array_synapses_3__synaptic_pre.size();
_dynamic_array_synapses_3__synaptic_post.resize(newsize);
_dynamic_array_synapses_3__synaptic_pre.resize(newsize);
_dynamic_array_synapses_3_Apostsyn_BC_E.resize(newsize);
_dynamic_array_synapses_3_Apresyn_BC_E.resize(newsize);
_dynamic_array_synapses_3_delay_1.resize(newsize);
_dynamic_array_synapses_3_lastupdate.resize(newsize);
_dynamic_array_synapses_3_w_BC_E.resize(newsize);
