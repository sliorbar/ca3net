...
void _run_synapses_3_pre_codeobject_1()
{
...
const double dApresyn_BC_E = - 0.018000000000000002;
...
const double norm_BC_E = 2.0849439043759546;
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_3__synaptic_post.size();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double x_gaba = _ptr_array_neurongroup_x_gaba[_postsynaptic_idx];
            ...
            w_BC_E = _clip(w_BC_E + Apostsyn_BC_E, 0, wmax_BC_E);
            lastupdate = t;
            ...
            _ptr_array_neurongroup_x_gaba[_postsynaptic_idx] = x_gaba;
...
void _debugmsg_synapses_3_pre_codeobject_1()
{
    using namespace brian;
