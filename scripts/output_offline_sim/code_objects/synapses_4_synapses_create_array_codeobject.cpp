...
const size_t _numsources = 22444;
const size_t _numtargets = 22444;
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_4__synaptic_post.size();
const size_t _num_presynaptic_idx = _dynamic_array_synapses_4__synaptic_pre.size();
    ///// POINTERS ////////////
...
const size_t _old_num_synapses = _ptr_array_synapses_4_N[0];
...
const size_t newsize = _dynamic_array_synapses_4__synaptic_pre.size();
_dynamic_array_synapses_4__synaptic_post.resize(newsize);
_dynamic_array_synapses_4__synaptic_pre.resize(newsize);
_dynamic_array_synapses_4_Apostsyn_BC_I.resize(newsize);
_dynamic_array_synapses_4_Apresyn_BC_I.resize(newsize);
_dynamic_array_synapses_4_delay_1.resize(newsize);
_dynamic_array_synapses_4_lastupdate.resize(newsize);
_dynamic_array_synapses_4_w_BC_I.resize(newsize);
