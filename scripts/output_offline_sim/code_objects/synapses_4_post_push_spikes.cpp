...
void _run_synapses_4_post_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_synapses_4_delay_1.size();
    ...
    {
        synapses_4_post.advance();
        synapses_4_post.push(_ptr_array_neurongroup_1__spikespace, _ptr_array_neurongroup_1__spikespace[_num_spikespace-1]);
    }
