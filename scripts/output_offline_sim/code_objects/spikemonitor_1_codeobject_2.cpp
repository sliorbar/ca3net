...
void _run_spikemonitor_1_codeobject_2()
{
    ...
    if (_num_events > 0)
    {
        ...
        if (_num_events > 0) {
            ...
            for(size_t _j=_start_idx; _j<_end_idx; _j++)
            {
                ...
                _ptr_array_spikemonitor_1_count[_idx-_source_start]++;
            }
...
void _debugmsg_spikemonitor_1_codeobject_2()
{
    using namespace brian;
    const size_t _numN = 1;
const size_t _num_clock_t = 1;
