...
void _run_synapses_2_pre_codeobject_1()
{
    using namespace brian;


    ///// CONSTANTS ///////////
    double* const _array_synapses_2_Apostsyn_PC_I = _dynamic_array_synapses_2_Apostsyn_PC_I.empty()? 0 : &_dynamic_array_synapses_2_Apostsyn_PC_I[0];
const size_t _numApostsyn_PC_I = _dynamic_array_synapses_2_Apostsyn_PC_I.size();
double* const _array_synapses_2_Apresyn_PC_I = _dynamic_array_synapses_2_Apresyn_PC_I.empty()? 0 : &_dynamic_array_synapses_2_Apresyn_PC_I[0];
const size_t _numApresyn_PC_I = _dynamic_array_synapses_2_Apresyn_PC_I.size();
...
const double dApresyn_PC_I = - 0.012;
...
const double norm_PC_I = 1.3980797767311548;
const size_t _numt = 1;
const double tau_PC_I = 0.015;
double* const _array_synapses_2_w_PC_I = _dynamic_array_synapses_2_w_PC_I.empty()? 0 : &_dynamic_array_synapses_2_w_PC_I[0];
const size_t _numw_PC_I = _dynamic_array_synapses_2_w_PC_I.size();
const double wmax_PC_I = 1.2;
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses_2__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_synapses_2_Apostsyn_PC_I = _array_synapses_2_Apostsyn_PC_I;
    double* __restrict  _ptr_array_synapses_2_Apresyn_PC_I = _array_synapses_2_Apresyn_PC_I;
    ...
    double* __restrict  _ptr_array_synapses_2_w_PC_I = _array_synapses_2_w_PC_I;
    ...
    const double _lio_1 = 1.0f*1.0/tau_PC_I;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double Apostsyn_PC_I = _ptr_array_synapses_2_Apostsyn_PC_I[_idx];
            double Apresyn_PC_I = _ptr_array_synapses_2_Apresyn_PC_I[_idx];
            double lastupdate = _ptr_array_synapses_2_lastupdate[_idx];
            double w_PC_I = _ptr_array_synapses_2_w_PC_I[_idx];
            double x_ampa = _ptr_array_neurongroup_1_x_ampa[_postsynaptic_idx];
            const double _Apostsyn_PC_I = Apostsyn_PC_I * exp(_lio_1 * (- (t - lastupdate)));
            const double _Apresyn_PC_I = Apresyn_PC_I * exp(_lio_1 * (- (t - lastupdate)));
            Apostsyn_PC_I = _Apostsyn_PC_I;
            Apresyn_PC_I = _Apresyn_PC_I;
            x_ampa += norm_PC_I * w_PC_I;
            Apresyn_PC_I += dApresyn_PC_I;
            w_PC_I = _clip(w_PC_I + Apostsyn_PC_I, 0, wmax_PC_I);
            lastupdate = t;
            _ptr_array_synapses_2_Apostsyn_PC_I[_idx] = Apostsyn_PC_I;
            _ptr_array_synapses_2_Apresyn_PC_I[_idx] = Apresyn_PC_I;
            _ptr_array_synapses_2_lastupdate[_idx] = lastupdate;
            _ptr_array_synapses_2_w_PC_I[_idx] = w_PC_I;
            _ptr_array_neurongroup_1_x_ampa[_postsynaptic_idx] = x_ampa;
...
void _debugmsg_synapses_2_pre_codeobject_1()
{
    using namespace brian;
