...
void _run_synapses_2_post_codeobject_1()
{
...
const double dApostsyn_PC_I = 0.012;
...
const double wmax_PC_I = 1.2;
    ...
    {
    std::vector<int> *_spiking_synapses = synapses_2_post.peek();
        ...
        _spiking_synapse_idx++)
    {
        ...
        w_PC_I = _clip(w_PC_I + Apresyn_PC_I, 0, wmax_PC_I);
        lastupdate = t;
...
void _debugmsg_synapses_2_post_codeobject_1()
{
    using namespace brian;
