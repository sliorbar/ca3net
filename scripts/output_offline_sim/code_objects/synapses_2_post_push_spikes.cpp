...
void _run_synapses_2_post_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_synapses_2_delay_1.size();
    ...
    {
        synapses_2_post.advance();
        synapses_2_post.push(_ptr_array_neurongroup_1__spikespace, _ptr_array_neurongroup_1__spikespace[_num_spikespace-1]);
    }
