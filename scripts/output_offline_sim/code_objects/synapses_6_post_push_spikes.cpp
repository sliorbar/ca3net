...
void _run_synapses_6_post_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_synapses_6_delay_1.size();
    ...
    {
        synapses_6_post.advance();
        synapses_6_post.push(_ptr_array_neurongroup__spikespace, _ptr_array_neurongroup__spikespace[_num_spikespace-1]);
    }
