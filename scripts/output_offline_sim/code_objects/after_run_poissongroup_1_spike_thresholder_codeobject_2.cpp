...
void _after_run_poissongroup_1_spike_thresholder_codeobject_2()
{
    using namespace brian;
    ///// CONSTANTS ///////////
    const int64_t N = 60;
const size_t _num_spikespace = 61;
const size_t _numdt = 1;
const size_t _numrates = 60;
    ///// POINTERS ////////////
        
    int32_t* __restrict  _ptr_array_poissongroup_1__spikespace = _array_poissongroup_1__spikespace;
    double*   _ptr_array_defaultclock_dt = _array_defaultclock_dt;
    double* __restrict  _ptr_array_poissongroup_1_rates = _array_poissongroup_1_rates;

_ptr_array_poissongroup_1__spikespace[N] = 0;  // Note that this is not an off-by-1-error: the array has N+1 elements
