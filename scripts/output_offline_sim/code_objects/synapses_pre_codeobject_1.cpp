...
void _run_synapses_pre_codeobject_1()
{
...
const double norm_PC_MF = 1.5188811219089113;
const double w_PC_MF = 21.5;
...
const size_t _num_postsynaptic_idx = _dynamic_array_synapses__synaptic_post.size();
    ...
    const double _lio_1 = norm_PC_MF * w_PC_MF;
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            double x_ampaMF = _ptr_array_neurongroup_x_ampaMF[_postsynaptic_idx];
            x_ampaMF += _lio_1;
            _ptr_array_neurongroup_x_ampaMF[_postsynaptic_idx] = x_ampaMF;
...
void _debugmsg_synapses_pre_codeobject_1()
{
    using namespace brian;
