...
void _run_synapses_3_post_push_spikes()
{
...
const size_t _numdelay = _dynamic_array_synapses_3_delay_1.size();
    ...
    {
        synapses_3_post.advance();
        synapses_3_post.push(_ptr_array_neurongroup__spikespace, _ptr_array_neurongroup__spikespace[_num_spikespace-1]);
    }
