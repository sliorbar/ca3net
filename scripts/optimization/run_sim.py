...
Parameters are duplicated from `spw_network.py`... but this is the easiest way to implement the changes needed here (weight setup)
authors: Bence Bagi, András Ecker last update: 09.2018
"""
