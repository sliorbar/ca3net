...
stdp_post_scale_factor = 0.0 # Post before pre factor - Positive number is LTD
stdp_pre_scale_factor = 0.0    #Use to modify the pre / post window - Positive number is LTP
